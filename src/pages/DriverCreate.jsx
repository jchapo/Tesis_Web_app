  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        navigate('/drivers', {
          state: {
            message: `Motorizado ${formData.nombre} ${formData.apellido} creado exitosamente`,
            type: 'success'
          }
        })
      } else {
        setError(result.message || 'Error al crear el motorizado')
      }
    } catch (err) {
      console.error('Error al crear motorizado:', err)
      setError('Error inesperado al crear el motorizado')
    } finally {
      setLoading(false)
    }
  }
          ...
          <div className="bg-background-light dark:bg-background-dark p-6 md:p-8 rounded-xl border border-gray-200 dark:border-white/10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" htmlFor="licencia">
                    Número de Licencia
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                      El motorizado podrá cambiarla después de iniciar sesión
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Datos del Vehículo (Opcional)</h2>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block" htmlFor="vehiculoPlaca">
                      Placa
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block" htmlFor="vehiculoModelo">
                      Modelo
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block" htmlFor="vehiculoColor">
                      Color
                    </label>
                    <input
                      type="text"
              ...
              <div className="flex items-center justify-end gap-4 pt-4">
                ...
                >
                  ...
                  <span>{loading ? 'Creando...' : 'Guardar Motorizado'}</span>
                </button>
              </div>
            </form>
          </div>
